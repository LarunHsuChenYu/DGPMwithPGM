...
public class LayerDependencyTests
{
    ...
    private static readonly Assembly InfrastructureAssembly =
        typeof(PGM.Infrastructure.Persistence.DbSession).Assembly;

    private const string InfrastructureNamespace = "PGM.Infrastructure";
    private const string ApiNamespace = "PGM.Api";
    ...
    public void Interfaces_ShouldStartWith_I()
    {
        ...
        var result = Types.InAssembly(CoreAssembly)
            .That().AreInterfaces()
            .And().ResideInNamespace("PGM.Core.Application.Interfaces")
            .Should()
